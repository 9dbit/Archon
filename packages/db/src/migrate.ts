...
const MIGRATIONS=[{id:'0000_archon_foundation',file:'0000_archon_foundation.sql'},{id:'0001_casa_nusa_canonical_geometry',file:'0001_casa_nusa_canonical_geometry.sql'}] as const;
