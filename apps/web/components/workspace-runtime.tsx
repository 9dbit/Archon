  ...
  return <>
    ...
    <div className="viewport-wrap">
      <div className="cad-grid"><div className="dimension dim-top">24,800 mm</div><div className="dimension dim-left">15,000 mm</div><div className="floorplan">
        <div className="room kitchen" style={{gridArea:'kitchen','--room-tone':'#c7ced2'} as CSSProperties}><b>KITCHEN</b><span>A: 45.0 m²</span><small>FFL +0.000</small></div>
        <div className="room storage" style={{gridArea:'storage','--room-tone':'#d7d7d2'} as CSSProperties}><b>STORAGE</b><span>A: 12.0 m²</span></div>
        <div className="room restroom1" style={{gridArea:'restroom1','--room-tone':'#c4d1d9'} as CSSProperties}><b>RESTROOM M</b><span>A: 18.0 m²</span></div>
        <div className="room restroom2" style={{gridArea:'restroom2','--room-tone':'#c4d1d9'} as CSSProperties}><b>RESTROOM F</b><span>A: 18.0 m²</span></div>
        <div className="room bar" style={{gridArea:'bar','--room-tone':'#7b8d91'} as CSSProperties}><b>BAR</b><span>A: 20.0 m²</span></div>
        <div className="room dining" style={{gridArea:'dining','--room-tone':'#ded4bd'} as CSSProperties}><b>INDOOR DINING</b><span>A: 120.0 m²</span></div>
        <div className="room entrance" style={{gridArea:'entrance','--room-tone':'#d9c9ab'} as CSSProperties}><b>MAIN ENTRANCE</b><span>A: 15.0 m²</span></div>
        <div className="room outdoor" style={{gridArea:'outdoor','--room-tone':'#ceb890'} as CSSProperties}><b>OUTDOOR DINING</b><span>A: 80.0 m²</span></div>
        <div className="room terrace" style={{gridArea:'terrace','--room-tone':'#b79068'} as CSSProperties}><b>OCEAN VIEW TERRACE</b><span>A: 40.0 m²</span></div>
