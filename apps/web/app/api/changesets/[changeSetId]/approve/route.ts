...
export async function POST(
  ...
  try {
    ...
    const status =
      message === 'DATABASE_URL_NOT_CONFIGURED' ? 503 :
      message === 'CHANGESET_NOT_FOUND' ? 404 :
      message.startsWith('CHANGESET_NOT_APPROVABLE') || message === 'VALIDATION_BLOCKS_APPROVAL' ? 409 :
      500;
